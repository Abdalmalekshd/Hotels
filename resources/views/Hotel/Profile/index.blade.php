...
<div class="row">
    <div class="col-md-12">
        <img class='hotelphoto' src="{{ asset('images/hotels/'.$hotel->photo) }}" alt="">
</div>
...
<img class="card-img roomimg" style="margin-right: 0px" src="{{ url('images/rooms/'.$img->img) }}" alt="{{ $room->room_id }}">
