...
<div class="container">
    ...
    <div class="create" style="margin-top: 100px;">
        ...
        <form class="form-group" method="POST" action="{{ route('User.Resetpass') }}" enctype="multipart/form-data">
            @csrf


            <input type="hidden" class="form-control" name="email" value="{{ $user->email }}"  placeholder="{{ __('hotel.newpass') }}">
