...
Route::group(
    ...
    Route::group(['prefix'=>'Hotels/user','middleware' => ['auth:web']],function(){
...
//Start Reservation Routes
    ...
    Route::get('reser','ReservationController@resrivation')->name('resrive.room');
...
//End Reservation Routes
    ...
    // Route::get('PreviewCity/{id}','HotelController@previewcity')->name('precity');

    // Route::get('PreviewCountry/{id}','HotelController@previewcountry')->name('precountry');
